...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    private static void init() {
		...
		frame.setLocation((int)Toolkit.getDefaultToolkit().getScreenSize().getWidth() / 2 - ((height/2) + (height/4)),(int)Toolkit.getDefaultToolkit().getScreenSize().getHeight() / 2 - (height/2));
